...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_547757e2d7f8b9_18029892',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_547757e2d7f8b9_18029892')) {function content_547757e2d7f8b9_18029892($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <title>Music</title>
...
function getStatus(){
  ...
  window.profileCover="musicCover.jpg";
  ...
  $(document).ready(function() {
    ...
    $('#btnCrop').on('click', function() {
      ...
      $.ajax({
        ...
        url: "http://localhost:81/mttk-php/profileController/suaProfileCover",
