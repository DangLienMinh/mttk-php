...
class ProfileController extends CI_Controller {
    ...
    public function getEducationAndReligion()
    {
        ...
        <div class="edit" style="display:none">
          ...
          if($k['education']==""){
            $content.='<div class="aboutTitle"><span>EDUCATION</span><div class="mainbox"><a class="insertAbout">Write something about your religion</a><a href="#" class="edit_link" style="display:none" title="Edit">Edit</a><div class="text_wrapper"></div>
        <div class="edit" style="display:none">
          <textarea class="editbox" cols="23" rows="3" name="education"></textarea>
        </div></div></div>';
          }else{
