...
$(document).on('click', '.stedit', function(e) {
	...
	topParent.find('.strmsg').append('<textarea style="width:290px;height:40px">'+status_msg+'</textarea><br/><button id="'+status_id+'" value="Change" class="editStatus">Finish editing</button><button value="Change" class="cancelEdit">Cancel</button>');
});
